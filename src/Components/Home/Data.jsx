...
const Data = () => {
    const[typeEffect] = useTypewriter({
      words: ["a Web Developer.", "a Creative Web Designer.", "a Freelancer."],
      loop: {},
      typeSpeed: 100,
      deleteSpeed: 40
    })
  ...
  return (
    <div className="home__data">
        <h1 className="home__title"> Hey! I'm
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h1 className="home__subtitle"> SALAM CHAUDHARY</h1>

        <h3 className="home__subtitle1">I'm {typeEffect} </h3>
